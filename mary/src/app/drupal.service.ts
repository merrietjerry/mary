...
export class DrupalService {
    ...
    public siteName: string = 'Our Lady of Fatima Church';

    private drupalBasePath: string = 'http://www.ourladyoffatima.in';

    private apiBasePath : string = 'http://www.ourladyoffatima.in/church/api/';
    ...
    getFooterMenu(){
        return this._http.get(this.apiBasePath+'footer-menu').map((response: Response) => response.json());
    }
    ...
    getMinistry(){
        return this._http.get(this.apiBasePath+'ministry').map((response: Response) => response.json());
    }

    getPriestHome() {
        return this._http.get(this.apiBasePath+'priest-home').map((response: Response) => response.json());
    }

    getBishop() {
        return this._http.get(this.apiBasePath+'bishop').map((response: Response) => response.json());
    }
